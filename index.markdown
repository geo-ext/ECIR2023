...
A special issue entitled <span style="background-color: yellow; font-size:22px; "> [Geographic Information Extraction from Texts](https://www.sciencedirect.com/journal/information-processing-and-management/about/call-for-papers#geographic-information-extraction-from-texts) </span>on Information Processing & Management (IF:7.4) is open for submission till September 1st, 2023.
